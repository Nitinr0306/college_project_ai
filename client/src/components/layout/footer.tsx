      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-neutral-400 mb-6">
              Empowering developers to build eco-friendly websites with AI-driven tools and sustainability metrics.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/#estimator" className="text-neutral-400 hover:text-white transition-colors">Carbon Estimator</Link></li>
              <li><Link href="/#gamification" className="text-neutral-400 hover:text-white transition-colors">Gamification</Link></li>
              <li><Link href="/dashboard" className="text-neutral-400 hover:text-white transition-colors">Dashboard</Link></li>
              <li><a href="#" className="text-neutral-400 hover:text-white transition-colors">AI Chatbot</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-neutral-700 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <p className="text-neutral-400 mb-4 md:mb-0">© {new Date().getFullYear()} GreenWeb. All rights reserved.</p>
